...
document.addEventListener( 'DOMContentLoaded', function () {
    slider('.splide', options).mount();
} );

function sliderTpl({poster_path, original_title}) {
    return `<li class="splide__slide slider-card">
    <img class="slider-img" src="https://image.tmdb.org/t/p/w500${poster_path}" alt="${original_title}"/>
    </li>`
}
